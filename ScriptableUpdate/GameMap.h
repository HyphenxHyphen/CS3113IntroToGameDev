...
class GameMap : public ScriptableScript
{
private:
	bool m_collidable;
	bool m_pit;
...
public:
	...
	// Constructor
	GameMap();
	GameMap(bool collidable, bool pit, int width, int height, unsigned int animIndex, std::map<unsigned int, std::vector<int>> anims, unsigned int startingAnim,
